...
def build_project_software(
    ...
    print(f"build_project_software----->>: software_name={software_name}, version={version}, version_code={version_code}, version_description={version_description}, build_command={build_command}, build_output_subdir={build_output_subdir}, software_manifest_id={software_manifest_id}, source_dir={source_dir}, build_output_dir={build_output_dir}, build_duration_ms={build_duration_ms}")
    ...
    print(f"build_project_software----->>: software_name={software_name}, version={version}, version_code={version_code}, version_description={version_description}, build_command={build_command}, build_output_subdir={build_output_subdir}, software_manifest_id={software_manifest_id}, source_dir={source_dir}, build_output_dir={build_output_dir}")
    ...
    print(f"preupload build_version.json payload: {build_version_preupload_payload}")
    status_code, build_version_preupload_data, text = http_post_json(preupload_url, build_version_preupload_payload, timeout=10)
    print(f"preupload build_version.json response: {status_code}, {build_version_preupload_data}, {text}")
    if not (200 <= int(status_code) < 300):
